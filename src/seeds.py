...
class Seeds:
    ...
    not_narcotics = {'suspect', 'medicine', 'gans', 'lab', 'dispensary', 'pain', 'sleeping', 'mouse', 'alliance',
                     ...
                     'boots', 'alter', 'delirium', 'asphyxiation', 'gamma',
                     'wholesaler'}
    not_weapons = {'addictive', 'bloodstaine', 'grievous', 'model', 'millimeter', 'instrument', 'plate', 'flame',
                   ...
                   'carve'}
    not_investigation = {'cache', 'drink', 'mask', 'scrap', 'id', 'protective', 'rest', 'surrey', 'prison', 'heart',
                         ...
                         'unregistered', 'reconvicted', 'zeus', 'knifepoint',
